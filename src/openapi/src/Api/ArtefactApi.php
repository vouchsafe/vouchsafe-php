...
class ArtefactApi
{
     ...
     * @return \Vouchsafe\OpenAPI\Model\GetArtefactResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse
     */
     ...
     * @throws \Vouchsafe\OpenAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Vouchsafe\OpenAPI\Model\GetArtefactResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse|\Vouchsafe\OpenAPI\Model\ApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Vouchsafe\OpenAPI\Model\GetArtefactResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Vouchsafe\OpenAPI\Model\GetArtefactResponse';
        $request = $this->getArtefactRequest($artefact_key, $contentType);
    ...
    public function getArtefactRequest($artefact_key, string $contentType = self::contentTypes['getArtefact'][0])
    {
        ...
        $resourcePath = '/artefact/{artefact_key}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($artefact_key !== null) {
            $resourcePath = str_replace(
                '{' . 'artefact_key' . '}',
                ObjectSerializer::toPathValue($artefact_key),
                $resourcePath
            );
        }
