...
/**
 * VideoSelfieValidations Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class VideoSelfieValidations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VideoSelfieValidations';
    ...
    protected static $openAPITypes = [
        'referee_dissimilarity_check' => '\Vouchsafe\OpenAPI\Model\CheckStatus',
        'liveness_check' => '\Vouchsafe\OpenAPI\Model\CheckStatus'
    ];
    ...
    protected static array $openAPINullables = [
        'referee_dissimilarity_check' => true,
        'liveness_check' => true
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['liveness_check'] === null && !$this->isNullableSetToNull('liveness_check')) {
     ...
     *
     * @return \Vouchsafe\OpenAPI\Model\CheckStatus|null
     */
     ...
     *
     * @param \Vouchsafe\OpenAPI\Model\CheckStatus|null $referee_dissimilarity_check referee_dissimilarity_check
     *
     * @return self
     */
    public function setRefereeDissimilarityCheck($referee_dissimilarity_check)
    {
        if (is_null($referee_dissimilarity_check)) {
            array_push($this->openAPINullablesSetToNull, 'referee_dissimilarity_check');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('referee_dissimilarity_check', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets liveness_check
     *
     * @param \Vouchsafe\OpenAPI\Model\CheckStatus|null $liveness_check liveness_check
     *
     * @return self
     */
    public function setLivenessCheck($liveness_check)
    {
        if (is_null($liveness_check)) {
            array_push($this->openAPINullablesSetToNull, 'liveness_check');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('liveness_check', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
