...
/**
 * ReviewUserCheck Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class ReviewUserCheck implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReviewUserCheck';
    ...
    protected static $openAPITypes = [
        ...
        'check_type' => 'string',
        'confirmed_claims' => '\Vouchsafe\OpenAPI\Model\ReviewUserCheckAllOfConfirmedClaims'
    ];
    ...
    public const CHECK_TYPE_VERIFY_USER_DETAILS = 'verify_user_details';
    ...
    {
        return [
            self::CHECK_TYPE_VERIFY_USER_DETAILS,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['confirmed_claims'] === null && !$this->isNullableSetToNull('confirmed_claims')) {
     ...
     *
     * @return \Vouchsafe\OpenAPI\Model\ReviewUserCheckAllOfConfirmedClaims|null
     */
     ...
     *
     * @param \Vouchsafe\OpenAPI\Model\ReviewUserCheckAllOfConfirmedClaims|null $confirmed_claims confirmed_claims
     *
     * @return self
     */
    public function setConfirmedClaims($confirmed_claims)
    {
        if (is_null($confirmed_claims)) {
            array_push($this->openAPINullablesSetToNull, 'confirmed_claims');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('confirmed_claims', $nullablesSetToNull);
            if ($index !== FALSE) {
