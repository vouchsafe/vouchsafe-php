<?php
/**
 * BaseCheckVerifyEmailOrVerifyPhoneNumber
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * BaseCheckVerifyEmailOrVerifyPhoneNumber Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class BaseCheckVerifyEmailOrVerifyPhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseCheck_verify_email-or-verify_phone_number_';
    ...
    public const CHECK_TYPE_VERIFY_EMAIL = 'verify_email';
    public const CHECK_TYPE_VERIFY_PHONE_NUMBER = 'verify_phone_number';
    ...
    {
        return [
            self::CHECK_TYPE_VERIFY_EMAIL,
            self::CHECK_TYPE_VERIFY_PHONE_NUMBER,
        ];
    }
