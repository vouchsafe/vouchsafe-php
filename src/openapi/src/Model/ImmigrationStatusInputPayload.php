...
/**
 * ImmigrationStatusInputPayload Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class ImmigrationStatusInputPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImmigrationStatusInput_payload';
    ...
    */
     ...
     * Sets reason
     *
     * @param string $reason Reason for the verification (max 50 characters)
     *
     * @return self
     */
     ...
     * Sets job_title
     *
     * @param string $job_title Job title of the person being verified
     *
     * @return self
     */
