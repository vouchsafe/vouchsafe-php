...
/**
 * CreateDigitalIdSessionInput Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class CreateDigitalIdSessionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDigitalIdSessionInput';
    ...
    */
    ...
    public function setKnownClaims($known_claims)
    {
        if (is_null($known_claims)) {
            throw new \InvalidArgumentException('non-nullable known_claims cannot be null');
        }
