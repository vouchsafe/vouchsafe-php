<?php
/**
 * ApiVerificationEnrichmentAnyOf2
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ApiVerificationEnrichmentAnyOf2 Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class ApiVerificationEnrichmentAnyOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Api_VerificationEnrichment__anyOf_2';
    ...
    protected static $openAPITypes = [
        'details' => '\Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf2Details',
        'outcome' => 'string',
        'check' => 'string'
    ];
    ...
    public const CHECK_RADAR = 'radar';
    ...
    */
     ...
     * Gets details
     *
     * @return \Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf2Details
     */
     ...
     * Sets details
     *
     * @param \Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf2Details $details details
     *
     * @return self
     */
