<?php
/**
 * ApiVerificationEnrichmentAnyOf1
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ApiVerificationEnrichmentAnyOf1 Class Doc Comment
 *
 * @category Class
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 ...
 */
class ApiVerificationEnrichmentAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Api_VerificationEnrichment__anyOf_1';
    ...
    protected static $openAPITypes = [
        'details' => '\Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf1Details',
        'outcome' => 'string',
        'check' => 'string'
    ];
    ...
    public const CHECK_EMAIL_FOOTPRINT_ANALYSIS = 'email_footprint_analysis';
    public const CHECK_PHONE_FOOTPRINT_ANALYSIS = 'phone_footprint_analysis';
    ...
    {
        return [
            self::CHECK_EMAIL_FOOTPRINT_ANALYSIS,
            self::CHECK_PHONE_FOOTPRINT_ANALYSIS,
        ];
    }
    ...
    */
     ...
     * Gets details
     *
     * @return \Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf1Details
     */
     ...
     * Sets details
     *
     * @param \Vouchsafe\OpenAPI\Model\ApiVerificationEnrichmentAnyOf1Details $details details
     *
     * @return self
     */
