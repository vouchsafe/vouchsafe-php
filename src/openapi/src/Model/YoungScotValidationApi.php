...
class YoungScotValidationApi
{
     ...
     * Whether the correct document dimensions were detected (with score).
     *
     * @return YoungScotValidationApiDocumentBordersDetected
     */
    public function getDocumentBordersDetected(): YoungScotValidationApiDocumentBordersDetected
    {
     ...
     * Whether the correct document dimensions were detected (with score).
     *
     * @param YoungScotValidationApiDocumentBordersDetected $documentBordersDetected
     *
     * @return self
     */
    public function setDocumentBordersDetected(YoungScotValidationApiDocumentBordersDetected $documentBordersDetected): self
    {
     ...
     * Whether the photo ID face matches the video selfie (with score).
     *
     * @return YoungScotValidationApiFaceMatch
     */
    public function getFaceMatch(): YoungScotValidationApiFaceMatch
    {
     ...
     * Whether the photo ID face matches the video selfie (with score).
     *
     * @param YoungScotValidationApiFaceMatch $faceMatch
     *
     * @return self
     */
    public function setFaceMatch(YoungScotValidationApiFaceMatch $faceMatch): self
    {
