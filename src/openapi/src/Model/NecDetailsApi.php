...
class NecDetailsApi
{
     ...
     * ITSO Shell Reference Number (18 digits), if extracted. Otherwise null.
     *
     * @param string|null $smartCardNumber
     *
     * @return self
     */
    public function setSmartCardNumber(?string $smartCardNumber): self
    {
        $this->initialized['smartCardNumber'] = true;
