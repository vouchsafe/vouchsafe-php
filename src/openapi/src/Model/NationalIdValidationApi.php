...
class NationalIdValidationApi
{
     ...
     * Whether the correct document dimensions were detected (with score).
     *
     * @return NationalIdValidationApiDocumentBordersDetected
     */
    public function getDocumentBordersDetected(): NationalIdValidationApiDocumentBordersDetected
    {
     ...
     * Whether the correct document dimensions were detected (with score).
     *
     * @param NationalIdValidationApiDocumentBordersDetected $documentBordersDetected
     *
     * @return self
     */
    public function setDocumentBordersDetected(NationalIdValidationApiDocumentBordersDetected $documentBordersDetected): self
    {
     ...
     * Whether the photo ID face matches the video selfie (with score).
     *
     * @return NationalIdValidationApiFaceMatch
     */
    public function getFaceMatch(): NationalIdValidationApiFaceMatch
    {
     ...
     * Whether the photo ID face matches the video selfie (with score).
     *
     * @param NationalIdValidationApiFaceMatch $faceMatch
     *
     * @return self
     */
    public function setFaceMatch(NationalIdValidationApiFaceMatch $faceMatch): self
    {
