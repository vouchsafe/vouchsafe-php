...
/**
 * GetArtefactsResponse Class Doc Comment
 *
 * @category Class
 * @description Response returned by &#x60;GET /artefacts/{artefact_key}&#x60;
 * @package  Vouchsafe\OpenAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetArtefactsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetArtefactsResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['artefact_key'] === null) {
     ...
     * Sets artefact_key
     *
     * @param string $artefact_key The requested artefact key
     *
     * @return self
     */
    public function setArtefactKey($artefact_key)
    {
        if (is_null($artefact_key)) {
            throw new \InvalidArgumentException('non-nullable artefact_key cannot be null');
        }
     ...
     * Sets download_url
     *
     * @param string $download_url Time-limited pre-signed URL to download the file
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param string $expires_at Expiry time of the download URL (ISO 8601 UTC)
     *
     * @return self
     */
     ...
     *
     * @param float $expires_in_seconds Number of seconds until the download URL expires
     *
     * @return self
     */
