...
class ApiPhotoIdCheckResultRecordedPreviousSubmissionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVIDENCE_TYPE_BIRTH_OR_ADOPTION_CERTIFICATE = 'BirthOrAdoptionCertificate';
    public const EVIDENCE_TYPE_MARRIAGE_CERTIFICATE = 'MarriageCertificate';
    public const EVIDENCE_TYPE_NATURALISATION_OR_REG_CERTIFICATE = 'NaturalisationOrRegCertificate';
    public const EVIDENCE_TYPE_EDUCATION_CERTIFICATE = 'EducationCertificate';
    public const EVIDENCE_TYPE_PAYE_TAX_SUMMARY = 'PAYETaxSummary';
    public const EVIDENCE_TYPE_PAYSLIP = 'Payslip';
    public const EVIDENCE_TYPE_PENSION_ANNUAL_STATEMENT = 'PensionAnnualStatement';
    public const EVIDENCE_TYPE_BENEFITS_LETTER = 'BenefitsLetter';
    public const EVIDENCE_TYPE_NHS_LETTER = 'NHSLetter';
    public const EVIDENCE_TYPE_BANK_STATEMENT = 'BankStatement';
    public const EVIDENCE_TYPE_CREDIT_CARD_STATEMENT = 'CreditCardStatement';
    public const EVIDENCE_TYPE_MORTGAGE_STATEMENT = 'MortgageStatement';
    public const EVIDENCE_TYPE_INSURANCE_POLICY_AGREEMENT = 'InsurancePolicyAgreement';
    public const EVIDENCE_TYPE_UTILITY_BILL = 'UtilityBill';
    public const EVIDENCE_TYPE_MOBILE_PHONE_BILL = 'MobilePhoneBill';
    public const EVIDENCE_TYPE_HMPPS_LETTER = 'HMPPSLetter';
    public const EVIDENCE_TYPE_OLDER_PERSON_BUS_PASS = 'OlderPersonBusPass';
    public const EVIDENCE_TYPE_MANUAL_ENTRY = 'ManualEntry';
    public const EVIDENCE_TYPE_CLAIMS_TO_VERIFY = 'ClaimsToVerify';
    public const EVIDENCE_TYPE_BANK_ACCOUNT = 'bank_account';
    ...
    public function getEvidenceTypeAllowableValues()
    {
        return [
            ...
            self::EVIDENCE_TYPE_BANK_ACCOUNT,
    ...
    */
     ...
     * Gets artefacts
     *
     * @return \Vouchsafe\OpenAPI\Model\ApiVideoSelfieCheckResultRecordedPreviousSubmissionsInnerArtefactsInner[]
     */
     ...
     * Sets artefacts
     *
     * @param \Vouchsafe\OpenAPI\Model\ApiVideoSelfieCheckResultRecordedPreviousSubmissionsInnerArtefactsInner[] $artefacts artefacts
     *
     * @return self
     */
