...
class SmartLookupInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $first_line_of_address (required) - Should be taken from GET /postcode endpoint
     *
     * @return self
     */
     ...
     * Sets postcode
     *
     * @param string $postcode (required) - Postcode used in GET /postcode
     *
     * @return self
     */
     ...
     * Sets date_of_birth
     *
     * @param string|null $date_of_birth (conditionally required) — Required when checks includes CreditBureau; otherwise optional. Format as YYYY-MM-DD or ISO 8601
     *
     * @return self
     */
     ...
     * Sets checks
     *
     * @param string[] $checks (required) - Experimental, other checks coming soon
     *
     * @return self
     */
