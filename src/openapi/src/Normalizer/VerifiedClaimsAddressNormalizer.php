...
class VerifiedClaimsAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\VerifiedClaimsAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\VerifiedClaimsAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Vouchsafe\OpenAPI\Model\VerifiedClaimsAddress();
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('fullAddress') && null !== $data->getFullAddress()) {
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\VerifiedClaimsAddress::class => false];
    }
}