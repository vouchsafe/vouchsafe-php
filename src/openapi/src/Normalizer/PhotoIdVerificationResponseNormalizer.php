...
class PhotoIdVerificationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('extracted_details', $data)) {
            ...
            if (is_array($data['extracted_details']) and isset($data['extracted_details']['first_name']) and isset($data['extracted_details']['last_name']) and isset($data['extracted_details']['document_number']) and isset($data['extracted_details']['date_of_birth']) and isset($data['extracted_details']['expiration_date']) and isset($data['extracted_details']['date_of_issue']) and isset($data['extracted_details']['issuing_country']) and isset($data['extracted_details']['icao_format']) and isset($data['extracted_details']['mrz_code'])) {
