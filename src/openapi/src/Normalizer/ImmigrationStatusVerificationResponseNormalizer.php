...
class ImmigrationStatusVerificationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\ImmigrationStatusVerificationResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\ImmigrationStatusVerificationResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Vouchsafe\OpenAPI\Model\ImmigrationStatusVerificationResponse();
        ...
        if (\array_key_exists('extracted_details', $data)) {
            ...
            if (is_array($data['extracted_details'])) {
                $value = $this->denormalizer->denormalize($data['extracted_details'], \Vouchsafe\OpenAPI\Model\ImmigrationStatusExtractedDetails::class, 'json', $context);
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\ImmigrationStatusVerificationResponse::class => false];
    }
}