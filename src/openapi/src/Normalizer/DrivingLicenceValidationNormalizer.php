...
class DrivingLicenceValidationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\DrivingLicenceValidation::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\DrivingLicenceValidation::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Vouchsafe\OpenAPI\Model\DrivingLicenceValidation();
        ...
        if (\array_key_exists('required_fields_extracted', $data)) {
            ...
            if (is_array($data['required_fields_extracted']) and (isset($data['required_fields_extracted']['status']) and $data['required_fields_extracted']['status'] == 'pass')) {
                ...
                $value = $this->denormalizer->denormalize($data['required_fields_extracted'], \Vouchsafe\OpenAPI\Model\FailDrivingLicenceFailedReason::class, 'json', $context);
            }
        ...
        if (\array_key_exists('has_not_expired', $data)) {
            ...
            if (is_array($data['has_not_expired']) and (isset($data['has_not_expired']['status']) and $data['has_not_expired']['status'] == 'pass')) {
                ...
                $value_1 = $this->denormalizer->denormalize($data['has_not_expired'], \Vouchsafe\OpenAPI\Model\FailDrivingLicenceFailedReason::class, 'json', $context);
            }
        ...
        if (\array_key_exists('document_features_present', $data)) {
            ...
            if (is_array($data['document_features_present']) and (isset($data['document_features_present']['status']) and $data['document_features_present']['status'] == 'pass')) {
                $value_4 = $this->denormalizer->denormalize($data['document_features_present'], \Vouchsafe\OpenAPI\Model\Pass::class, 'json', $context);
            } elseif (is_array($data['document_features_present']) and (isset($data['document_features_present']['status']) and $data['document_features_present']['status'] == 'fail') and isset($data['document_features_present']['failed_reasons'])) {
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\DrivingLicenceValidation::class => false];
    }
}