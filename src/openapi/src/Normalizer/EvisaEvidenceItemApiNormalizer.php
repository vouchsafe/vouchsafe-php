...
class EvisaEvidenceItemApiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('extracted_details', $data)) {
            ...
            if (is_array($data['extracted_details']) and \array_key_exists('first_name', $data['extracted_details']) and \array_key_exists('last_name', $data['extracted_details']) and \array_key_exists('date_of_birth', $data['extracted_details']) and \array_key_exists('share_code', $data['extracted_details']) and \array_key_exists('reference_number', $data['extracted_details']) and \array_key_exists('immigration_status', $data['extracted_details']) and \array_key_exists('nationality', $data['extracted_details']) and \array_key_exists('expiration_date', $data['extracted_details']) and \array_key_exists('issue_date', $data['extracted_details'])) {
            ...
            } elseif (is_array($data['extracted_details']) and \array_key_exists('first_name', $data['extracted_details']) and \array_key_exists('last_name', $data['extracted_details']) and \array_key_exists('date_of_birth', $data['extracted_details']) and \array_key_exists('share_code', $data['extracted_details']) and \array_key_exists('reference_number', $data['extracted_details']) and \array_key_exists('expiration_date', $data['extracted_details'])) {
            ...
            } elseif (is_array($data['extracted_details']) and \array_key_exists('first_name', $data['extracted_details']) and \array_key_exists('last_name', $data['extracted_details']) and \array_key_exists('date_of_birth', $data['extracted_details']) and \array_key_exists('share_code', $data['extracted_details']) and \array_key_exists('reference_number', $data['extracted_details']) and \array_key_exists('expiration_date', $data['extracted_details']) and \array_key_exists('issue_date', $data['extracted_details'])) {
