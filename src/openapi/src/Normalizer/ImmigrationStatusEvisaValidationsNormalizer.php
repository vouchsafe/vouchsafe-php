...
class ImmigrationStatusEvisaValidationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaValidations::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaValidations::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaValidations();
        ...
        if (\array_key_exists('evisa_started', $data)) {
            $object->setEvisaStarted($this->denormalizer->denormalize($data['evisa_started'], \Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaStartedResult::class, 'json', $context));
        }
        if (\array_key_exists('evisa_not_expired', $data)) {
            $object->setEvisaNotExpired($this->denormalizer->denormalize($data['evisa_not_expired'], \Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaNotExpiredResult::class, 'json', $context));
        }
        return $object;
    }
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\ImmigrationStatusEvisaValidations::class => false];
    }
}