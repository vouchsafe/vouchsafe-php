...
class StepAddressDigitalIdApiExtractedDetailsAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\StepAddressDigitalIdApiExtractedDetailsAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\StepAddressDigitalIdApiExtractedDetailsAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Vouchsafe\OpenAPI\Model\StepAddressDigitalIdApiExtractedDetailsAddress();
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\StepAddressDigitalIdApiExtractedDetailsAddress::class => false];
    }
}