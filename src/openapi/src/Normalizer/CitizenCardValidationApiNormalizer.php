...
class CitizenCardValidationApiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\CitizenCardValidationApi::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\CitizenCardValidationApi::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Vouchsafe\OpenAPI\Model\CitizenCardValidationApi();
        ...
        if (\array_key_exists('document_borders_detected', $data)) {
            $object->setDocumentBordersDetected($this->denormalizer->denormalize($data['document_borders_detected'], \Vouchsafe\OpenAPI\Model\CitizenCardValidationApiDocumentBordersDetected::class, 'json', $context));
        }
        if (\array_key_exists('face_match', $data)) {
            $object->setFaceMatch($this->denormalizer->denormalize($data['face_match'], \Vouchsafe\OpenAPI\Model\CitizenCardValidationApiFaceMatch::class, 'json', $context));
        }
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\CitizenCardValidationApi::class => false];
    }
}