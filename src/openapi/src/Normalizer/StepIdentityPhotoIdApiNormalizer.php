...
class StepIdentityPhotoIdApiNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Vouchsafe\OpenAPI\Model\StepIdentityPhotoIdApi::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Vouchsafe\OpenAPI\Model\StepIdentityPhotoIdApi::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Vouchsafe\OpenAPI\Model\StepIdentityPhotoIdApi();
        ...
        if (\array_key_exists('validations', $data)) {
            ...
            if (is_array($data['validations']) and isset($data['validations']['required_fields_extracted']) and isset($data['validations']['document_borders_detected']) and isset($data['validations']['compound_identifiers_match']) and isset($data['validations']['icao_format_valid']) and isset($data['validations']['issuing_country_allowed'])) {
                $value_2 = $this->denormalizer->denormalize($data['validations'], \Vouchsafe\OpenAPI\Model\PassportValidationApi::class, 'json', $context);
            } elseif (is_array($data['validations']) and isset($data['validations']['required_fields_extracted']) and isset($data['validations']['document_borders_detected']) and isset($data['validations']['security_features_present']) and isset($data['validations']['identifier_format_valid']) and isset($data['validations']['not_sample_or_internal_use'])) {
            ...
            } elseif (is_array($data['validations']) and isset($data['validations']['required_fields_extracted']) and isset($data['validations']['document_borders_detected']) and isset($data['validations']['compound_identifiers_match']) and isset($data['validations']['icao_format_valid']) and isset($data['validations']['issuing_country_allowed'])) {
            ...
            } elseif (is_array($data['validations']) and isset($data['validations']['required_fields_extracted']) and isset($data['validations']['document_borders_detected']) and isset($data['validations']['matches_issuer_database'])) {
            ...
            } elseif (is_array($data['validations']) and isset($data['validations']['required_fields_extracted']) and isset($data['validations']['document_borders_detected']) and isset($data['validations']['security_features_present'])) {
    ...
    {
        return [\Vouchsafe\OpenAPI\Model\StepIdentityPhotoIdApi::class => false];
    }
}