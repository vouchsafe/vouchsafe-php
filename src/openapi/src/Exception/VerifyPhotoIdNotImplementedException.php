...
class VerifyPhotoIdNotImplementedException extends NotImplementedException
{
    /**
    ...
    {
        parent::__construct('Not implemented - RightToWork and RightToRent are coming soon');
