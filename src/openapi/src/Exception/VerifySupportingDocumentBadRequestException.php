...
class VerifySupportingDocumentBadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Bad request - invalid payload, missing fields, or unsupported file type');
