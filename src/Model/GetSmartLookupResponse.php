...
class GetSmartLookupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'team_id' => 'string',
        'checks' => '\Vouchsafe\Model\Model36EnumsBackgroundCheck[]',
        'first_name' => 'string',
        'last_name' => 'string',
        'first_line_of_address' => 'string',
        'postcode' => 'string',
        'address_verification_report' => '\Vouchsafe\Model\Report',
        'metadata' => 'mixed',
        'created_at' => 'string'
    ];
    ...
    */
     ...
     * Gets checks
     *
     * @return \Vouchsafe\Model\Model36EnumsBackgroundCheck[]
     */
     ...
     * Sets checks
     *
     * @param \Vouchsafe\Model\Model36EnumsBackgroundCheck[] $checks checks
     *
     * @return self
     */
     ...
     *
     * @param \Vouchsafe\Model\Report $address_verification_report Whether the overall check and its sub-checks passed, failed or somethng else.
     *
     * @return self
     */
