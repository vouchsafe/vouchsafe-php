...
class VerificationsApi
{
     ...
     * @return \Vouchsafe\Model\Verification|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse
     */
     ...
     * @throws \Vouchsafe\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Vouchsafe\Model\Verification|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Vouchsafe\Model\Verification';
        $request = $this->getVerificationRequest($id, $contentType);
     ...
     *
     * @param  \Vouchsafe\Model\Status|null $status Optional status filter. (optional)
     ...
     * @throws \Vouchsafe\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Vouchsafe\Model\Verification[]|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse
     */
     ...
     * @throws \Vouchsafe\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Vouchsafe\Model\Verification[]|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \Vouchsafe\Model\RequestVerificationInput $request_verification_input request_verification_input (required)
     ...
     * @throws \Vouchsafe\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Vouchsafe\Model\RequestVerificationResponse|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse
     */
     ...
     *
     * @param  \Vouchsafe\Model\RequestVerificationInput $request_verification_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['requestVerification'] to see the possible values for this operation
     *
     * @throws \Vouchsafe\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Vouchsafe\Model\RequestVerificationResponse|\Vouchsafe\Model\ApiErrorResponse|\Vouchsafe\Model\ApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestVerificationWithHttpInfo($request_verification_input, string $contentType = self::contentTypes['requestVerification'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Vouchsafe\Model\RequestVerificationResponse',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Vouchsafe\Model\RequestVerificationResponse';
        $request = $this->requestVerificationRequest($request_verification_input, $contentType);
